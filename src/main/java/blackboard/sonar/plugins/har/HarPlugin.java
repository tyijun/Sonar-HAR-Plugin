...
@Properties({
		...
		@Property(key = HarPluginConst.DB_DRIVER, name = "DB Driver", description = "The db driver when the HAR Analysis DataSource property is set to DB", defaultValue = "org.postgresql.Driver", project = true, global = true, type = PropertyType.STRING),
		@Property(key = HarPluginConst.DB_JDBCURL, name = "DB JDBC_URL", description = "The db jdbc_url when the HAR Analysis DataSource property is set to DB", defaultValue = "jdbc:postgresql://Harrepo.pd.local:5432/postgres", project = true, global = true, type = PropertyType.STRING),
		@Property(key = HarPluginConst.DB_USERNAME, name = "DB Username", description = "The db username when the HAR Analysis DataSource property is set to DB", defaultValue = "postgres", project = true, global = true, type = PropertyType.STRING),
